...
Use this software at own risk: it can potentially corrupt or remove your timechimp data.
I use the tool myself every day and I believe it is safe to use.
...
Feel free to review the source code to make sure the code is clean.
The released executables are automatically generated from source using GitHub Actions, you can verify that yourself as well. 
...
These will be only used to authenticate against the timechimp api.
If you set environment variable `CHIMPCLI_STORE_PASSWORD=true` before logging in,
then your credentials will be remembered so they can be reused if for some reason you need to re-login later.
...
<displays projects and tags>

<displays your logged hours for this week>
```
...
#  export CHIMPCLI_PASSWORD=hunter2
# chimp login
** successfully logged in as my.username@company.com
```
...
One litte inconvenience that you should know: these numbers for projects and tags can change over time.
...
MONDAY =============================================================================
[ 1] A second project (Customer) p2                08:30-09:30    1h my first cli tracked hour hooray
...
MONDAY =============================================================================
[ 1] A second project (Customer) p2                08:30-09:30     1h my first cli tracked hour hooray
[ 2] Project name (Customer) p1                    09:30-10:00    30m something else [tags: another_tag]


# chimp update 1 updated my note

MONDAY =============================================================================
[ 1] A second project (Customer) p2                08:30-09:30    1h updated my note
[ 2] Project name (Customer) p1                    09:30-10:00   30m something else [tags: another_tag]
...
In this file, your auth token and your username are stored, along with some cached data.
...
You need [dotnet sdk 10](https://dotnet.microsoft.com/en-us/download) to be able to compile the project.
...
# you can also build a self-contained executable, that can run without having dotnet installed
dotnet publish -c Release -o out --self-contained
```

## Troubleshooting

You may get some more verbose output by setting environment variable `CHIMPCLI_DEBUG=1`.
