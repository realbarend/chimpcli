...
public static class Localization
{
    ...
    public static string Localize(string literal, object? args = null)
    {
        ...
        var translated = literal switch
        {
            ...
            "login attempt failed, maybe wrong password. note: timechimp can temporarily block your account after multiple failures ({Message})" when language == UiLanguage.Nl => "inlogpoging mislukt, misschien verkeerd wachtwoord. letop: timechimp kan bij meerdere inlogfouten tijdelijk je account blokkeren",
